...
const helmetConfig = ((req,res,next) => {
    ...
    return helmet({
        contentSecurityPolicy: {
            directives: {
                defaultSrc: [ "'self'" ],
                scriptSrc: [ "'self'", nonce, "https://code.jquery.com", "https://cdn.jsdelivr.net", "https://unpkg.com", "https://sandbox.web.squarecdn.com", "https://web.squarecdn.com", "https://cdnjs.cloudflare.com", "https://maps.googleapis.com", "https://pay.google.com" ],
                styleSrc: [ "'self'", nonce , "https://code.jquery.com", "https://cdn.jsdelivr.net", "https://unpkg.com", "https://sandbox.web.squarecdn.com", "https://web.squarecdn.com", "https://cdnjs.cloudflare.com" ],
